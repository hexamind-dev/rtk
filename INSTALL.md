...
[Português (Brasil)](INSTALL_ptbr.md)
...
```bash
# From hexamind-dev/rtk (NOT reachingforthejack!)
...
- **GitHub issues**: https://github.com/hexamind-dev/rtk/issues
