...
### Root Cause
You installed the **wrong rtk package**. You have **Rust Type Kit** (reachingforthejack/rtk) instead of **Rust Token Killer** (hexamind-dev/rtk).
...
|---------|-----------|---------|-------------|
| **Rust Token Killer** ✅ | hexamind-dev/rtk | LLM token optimizer for Claude Code | `rtk gain` |
...
git clone https://github.com/hexamind-dev/rtk.git
...
- GitHub: https://github.com/hexamind-dev/rtk/issues
...
**Report issues:**
- Fork-specific: https://github.com/hexamind-dev/rtk/issues
- Upstream: https://github.com/hexamind-dev/rtk/issues
