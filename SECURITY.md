...
See [Dangerous Patterns Reference](https://github.com/hexamind-dev/rtk/wiki/Dangerous-Patterns) for exploitation examples.
...
- **General questions**: https://github.com/hexamind-dev/rtk/discussions
